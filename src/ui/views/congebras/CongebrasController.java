package ui.views.congebras;

import core.abc.*;
import core.excel.*;
import core.excel.congebras.CongebrasReport;
...
public class CongebrasController implements Initializable
{
    ...
    public void initialize(URL url, ResourceBundle resourceBundle)
    {
        ...
        initialFolderPathGoogle = prefs.get(UserPreferences.CONGEBRAS_GOOGLE_LAST_OPEN_FOLDER_PATH, null);
        initialFolderPathInvolves = prefs.get(UserPreferences.CONGEBRAS_INVOLVES_LAST_OPEN_FOLDER_PATH, null);
        initialFolderPathReport = prefs.get(UserPreferences.CONGEBRAS_REPORT_LAST_OPEN_FOLDER_PATH, null);
    ...
    private void fileIconPressed(MouseEvent event)
    {
        ...
        if (chosenFile != null)
        {
            ...
            if (imgView == googleOriginalIcon)
            {
                ...
                prefs.put(UserPreferences.CONGEBRAS_GOOGLE_LAST_OPEN_FOLDER_PATH, initialFolderPathGoogle);
            ...
            else if (imgView == involvesOriginalIcon)
            {
                ...
                prefs.put(UserPreferences.CONGEBRAS_INVOLVES_LAST_OPEN_FOLDER_PATH, initialFolderPathInvolves);
            ...
            else if (reportIconUse.equals(imgView))
            {
                ...
                prefs.put(UserPreferences.CONGEBRAS_REPORT_LAST_OPEN_FOLDER_PATH, initialFolderPathReport);
    ...
    private ArrayList<ProductRequest> getProductRequests() throws Exception
    {
        ...
        involvesSheetData = Filter.filterEquals(MandatoryFieldsGIV.MARCA, "CONGEBRAS", involvesSheetData);
        ...
        for (String storeName : requestItemsPerStore.keySet())
        {
            ArrayList<RequestItem> items = requestItemsPerStore.get(storeName);
            ////SortManager.sortItemsById(items);
        }
    ...
    private void updateFileButtonPressed(ActionEvent event)
    {
        ...
        try
        {
            CongebrasReport.updateReport(googleSheetData, requests, reportFilePath);
        }
        catch (Exception e)
        {
            e.printStackTrace();
